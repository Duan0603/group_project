        ...
        <div class="song-list">
            ...
            <div class="song-item"
                ...
                <div class="left">
                    ...
                    <img src="songImages/<%= dao.SongDAO.toImageFileName(s.getTitle()) %>" alt="cover" onerror="this.onerror=null; this.src='https://via.placeholder.com/48x48/333333/ffffff?text=♪';">
